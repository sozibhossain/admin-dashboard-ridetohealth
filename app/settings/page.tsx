      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="appName" defaultValue="Taxi Admin" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="email">Email</Label>
                <Input id="email" type="email" defaultValue="admin@taxi.com" />
              </div>
              <div className="space-y-2">
          ...
          <div className="flex justify-end">
            <Button className="bg-[#8B0000] hover:bg-[#700000]">Save Changes</Button>
          </div>
        </div>
      </div>
    </MainLayout>
